...
class CustomV1WithLineItemsTest {
  ...
  void givenACustomDocument_expected_3_lines() throws IOException {
    ...
    PredictResponse<CustomV1Inference> customDocumentInference = objectMapper.readValue(
      new File("src/test/resources/data/custom/response_v1/line_items/with_defined_anchor_3_expected_lines.json"),
      type);
    ...
    LineItems lineItems = LineItemsGenerator.generate(
      ...
      customDocumentInference.getDocument().getInference().getDocumentPrediction().getFields(),
