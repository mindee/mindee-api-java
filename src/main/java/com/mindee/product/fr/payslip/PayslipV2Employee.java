...
public class PayslipV2Employee extends BaseField {
  ...
  private Map<String, String> printableValues() {
    ...
    printable
      .put("registrationNumber", SummaryHelper.formatForDisplay(this.registrationNumber, null));
    printable
      .put("socialSecurityNumber", SummaryHelper.formatForDisplay(this.socialSecurityNumber, null));
    return printable;
  }
}
