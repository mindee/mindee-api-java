...
import com.mindee.v1.parsing.standard.CompanyRegistrationField;
import com.mindee.v1.parsing.standard.DateField;
import com.mindee.v1.parsing.standard.LocaleField;
import com.mindee.v1.parsing.standard.PaymentDetailsField;
import com.mindee.v1.parsing.standard.StringField;
import com.mindee.v1.parsing.standard.Taxes;
import com.mindee.v1.parsing.standard.TaxesDeserializer;
...
public class FinancialDocumentV1Document extends Prediction {
  ...
  /**
   * The type of the document: INVOICE or CREDIT NOTE if it is an invoice, CREDIT CARD RECEIPT or
   * EXPENSE RECEIPT if it is a receipt.
   */
  ...
  public String toString() {
    ...
    outStr.append(String.format(":Purchase Time: %s%n", this.getTime()));
