...
public final class DocumentResponseDeserializerFactory {
  ...
  private static <T extends BaseDocumentResponse & PredictionApiResponse<S, U>, S extends DocumentLevelResponse, U extends PageLevelResponse> DocumentResponseDeserializer<T, S, U> passportV1Deserializer() {
  ...
  private static <T extends BaseDocumentResponse & PredictionApiResponse<S, U>, S extends DocumentLevelResponse, U extends PageLevelResponse> DocumentResponseDeserializer<T, S, U> invoiceV3Deserializer() {
  ...
  private static <T extends BaseDocumentResponse & PredictionApiResponse<S, U>, S extends DocumentLevelResponse, U extends PageLevelResponse> DocumentResponseDeserializer<T, S, U> receiptResponseV3Deserializer() {
  ...
  private static <T extends BaseDocumentResponse & PredictionApiResponse<S, U>, S extends DocumentLevelResponse, U extends PageLevelResponse> DocumentResponseDeserializer<T, S, U> receiptResponseV4Deserializer() {
    return new DocumentResponseDeserializer(
      ReceiptV4Response::new, ReceiptV4Response.ReceiptDocument.class, ReceiptV4Response.ReceiptPage.class);
  }

  private static <T extends BaseDocumentResponse & PredictionApiResponse<S, U>, S extends DocumentLevelResponse, U extends PageLevelResponse> DocumentResponseDeserializer<T, S, U> invoiceResponseV4Deserializer() {
    return new DocumentResponseDeserializer(
