...
public final class DocumentResponseDeserializerFactory {
  ...
  public static <T extends BaseDocumentResponse & PredictionApiResponse<S,U>,
    S extends DocumentLevelResponse,
    U extends PageLevelResponse>
  DocumentResponseDeserializer<T,S,U> documentResponseDeserializerFromResponseClass(Class<T> responseClass)
  {
  ...
  private static <T extends BaseDocumentResponse & PredictionApiResponse<S,U>,
    S extends DocumentLevelResponse,
    U extends PageLevelResponse> DocumentResponseDeserializer<T,S,U> passportV1Deserializer()
  {
    return new DocumentResponseDeserializer(PassportV1Response::new,PassportV1Response.PassportDocument.class,PassportV1Response.PassportPage.class);
  }

  private static <T extends BaseDocumentResponse & PredictionApiResponse<S,U>,
    S extends DocumentLevelResponse,
    U extends PageLevelResponse> DocumentResponseDeserializer<T,S,U>
  invoiceV3Deserializer()
  {
    return new DocumentResponseDeserializer(InvoiceV3Response::new,InvoiceV3Response.InvoiceDocument.class,InvoiceV3Response.InvoicePage.class);
  }


  private static <T extends BaseDocumentResponse & PredictionApiResponse<S,U>,
    S extends DocumentLevelResponse,
    U extends PageLevelResponse> DocumentResponseDeserializer<T,S,U> receiptResponseV3Deserializer()
  {
  ...
  private static <T extends BaseDocumentResponse & PredictionApiResponse<S,U>,
    S extends DocumentLevelResponse,
    U extends PageLevelResponse> DocumentResponseDeserializer<T,S,U> receiptResponseV4Deserializer()
  {
    return new DocumentResponseDeserializer(
